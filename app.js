...
window.likePost = async function (postId, btn) {
    ...
    if (liked) {
        ...
        // Pop animation on like (not unlike) — classList.add after a
        // fresh className assignment above so the browser sees a real
        // style change and actually plays the animation, and the
        // 'animationend' listener strips the class afterward so the
        // next like on this same element can retrigger it too.
